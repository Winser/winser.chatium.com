...
interface InterAppCallRouteRef<B extends BS, R extends RS> {
...
export interface HsSearchableOptions extends HsCommonOptions {
  searchable?: {
...
export interface HsInterAppCallRouteRef<B extends HeapSchema, R extends HeapSchema>
  extends HsUnionable,
    Omit<tb.TTuple<[HsNumber, HsString, HsString]>, 'kind' | 'default'>,
    HsCommonOptions {
  $static: [number, string, string]
  $hsRuntime: InterAppCallRouteRef<B, R>
  $hsCreateInput: InterAppCallRouteRef<B, R>
  $hsUpdateInput: InterAppCallRouteRef<B, R>
  $hsFilterInput: InterAppCallRouteRef<B, R>
  $hsOrderInput: SortDirection
  kind: typeof InterAppCallRouteRefKind
  body: B
  result: R
}
export declare const InterAppCallRouteRefKind: unique symbol
...
export interface HsJobRouteRef<B extends HeapSchema>
  extends HsUnionable,
    Omit<tb.TTuple<[HsNumber, HsString, HsString]>, 'kind' | 'default'>,
    HsCommonOptions {
...
export declare type HsNonRequired<T extends HeapSchema> = T & {
  modifier: typeof NonRequiredModifier
}
...
export interface HsObject<T extends HsProperties> extends HsUnionable, HsIntersectable, HsOptionsWithDefault<T> {
