...
import { InterAppCallRouteRef } from '@app/types';
export type NodeType = {
    ...
    sourceData: {
        type: 'event';
        eventUrl: string;
        reactionsConfigRoute: InterAppCallRouteRef<typeof GetReactionsConfigParamsSchema, typeof ReactionConfigSchema>;
        clientConfigRoute: InterAppCallRouteRef<typeof GetClientConfigParamsSchema, typeof NodeClientConfigSchema>;
        analyticsConfigRoute?: InterAppCallRouteRef<typeof GetAnalyticsConfigParamsSchema, typeof AnalyticsConfigSchema>;
        settingsComponent?: [
            {
        ...
        type: 'action';
        actionRoute: InterAppCallRouteRef<typeof RunNodeActionsParamsSchema, typeof NodeActionResultSchema>;
        reactionsConfigRoute?: InterAppCallRouteRef<typeof GetReactionsConfigParamsSchema, typeof ReactionConfigSchema>;
        clientConfigRoute?: InterAppCallRouteRef<typeof GetClientConfigParamsSchema, typeof NodeClientConfigSchema>;
        settingsComponent?: [
            {
...
export type GetExternalNodesHookResult = {
    ...
    errorsCallbackRoute?: InterAppCallRouteRef<typeof ValidationErrorSchema, typeof HeapUnknown>;
    nodeTypes: NodeType[];
} | {
    categoryTitle: string;
