...
import { HeapTableNsType, UgcHeapApiV2 } from 'services/ugc-runner/runtime/runtimeTypes'
...
interface HssObject extends HsSerialized, hs.HsOptionsWithDefault<hs.HsProperties> {
  kind: 'ObjectKind'
  type: 'object'
  properties: Record<string, HsSerialized>
  required?: string[]
}
interface HsSerialized {
  kind: string
  modifier?: string
}
